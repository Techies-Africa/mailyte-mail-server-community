...
class WebhookDeliveryQueue:
        ...
        for attempt in range(max_retries + 1):
            try:
                ...
                if response.status_code < 400:
                    ...
                    logger.warning(f"Webhook delivery failed with status {response.status_code}: {webhook_url}")
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'success_rate': (self.delivered_count / (self.delivered_count + self.failed_count) * 100)
                           if (self.delivered_count + self.failed_count) > 0 else 100
        }
...
class RateLimitWebhookService:
    ...
    def send_quota_notification(self, quota_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            for webhook_config in webhook_urls:
                ...
                # Prepare webhook payload
                webhook_payload = self._prepare_webhook_payload(notification_payload, webhook_config)
    ...
    def _prepare_webhook_payload(self, data: Dict[str, Any], 
    ...
    def _prepare_webhook_headers(self, webhook_config: Dict[str, Any], 
