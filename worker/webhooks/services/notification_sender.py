...
class WebhookNotificationSender:
    ...
    def send_webhook(self, event_type: str, payload: Dict[str, Any], 
                    include_eml: bool = False, eml_content: str = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            for webhook_config in webhook_urls:
                result = self._send_single_webhook(
                    webhook_config, 
                    webhook_payload, 
                    event_config
                )
    ...
    def _prepare_payload(self, event_type: str, payload: Dict[str, Any], 
                        include_eml: bool, eml_content: str) -> Dict[str, Any]:
    ...
    def _get_webhook_urls(self, event_type: str) -> List[Dict[str, Any]]:
        ...
        try:
            if hasattr(self, 'database_service') and self.database_service:
                ...
                webhook_configs = self.database_service._execute_query(query, params, fetch_all=True)
                ...
                if webhook_configs:
                    for config in webhook_configs:
                        webhook_urls.append({
                            ...
                            'headers': json.loads(config['custom_headers']) if config['custom_headers'] else {},
    ...
    def _send_single_webhook(self, webhook_config: Dict[str, Any], 
                           payload: Dict[str, Any], event_config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def send_rate_limit_alert(self, organization_id: str, quota_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def send_rate_limit_exceeded(self, organization_id: str, limit_data: Dict[str, Any]) -> Dict[str, Any]:
