...
async def health_check(request: Request):
    ...
    try:
        ...
        config_valid = hasattr(request.app, 'tracking_service') and request.app.tracking_service.config.enabled
        ...
        try:
            ...
            health_data['components']['database'] = {
                ...
                'url': request.app.database_service.database_url.replace(
                    ...
                    '***'
                ) if hasattr(request.app.database_service, 'database_url') else 'not_configured'
            }
            if not db_healthy:
...
async def readiness_check(request: Request):
    ...
    try:
        ...
        required_services = ['database_service', 'tracking_service', 'webhook_service', 'rate_limiter']
