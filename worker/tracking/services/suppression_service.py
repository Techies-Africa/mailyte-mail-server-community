...
class SuppressionService:
    ...
    def add_bounce_suppression(self, email: str, bounce_type: str, bounce_reason: str, organization_id: str) -> bool:
    ...
    def add_complaint_suppression(self, email: str, complaint_reason: str, organization_id: str) -> bool:
    ...
    def add_unsubscribe_suppression(self, email: str, organization_id: str, unsubscribe_method: str = 'manual') -> bool:
    ...
    def get_suppression_stats(self, organization_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            for row in results:
                ...
                stats['by_type'][suppression_type] = {
                    'total': count,
                    'recent': recent_count
                }
    ...
    def _add_suppression(self, email: str, suppression_type: str, reason: str, organization_id: str) -> bool:
