...
async def track_pixel(tracking_id: str, request: Request):
    ...
    data, status = await proxy_to_tracking(
        request, f"/tracking/pixel/{tracking_id}", method="GET", params=dict(request.query_params)
    )
...
async def track_click(tracking_id: str, request: Request):
    ...
    data, status = await proxy_to_tracking(
        request, f"/tracking/click/{tracking_id}", method="GET", params=dict(request.query_params)
    )
    return JSONResponse(content=data, status_code=status)
...
async def get_domain_stats(domain: str, request: Request):
    ...
    data, status = await proxy_to_tracking(
        request, f"/stats/domain/{domain}", method="GET", params=dict(request.query_params)
    )
    return JSONResponse(content=data, status_code=status)
...
async def get_email_stats(email_id: str, request: Request):
    ...
    data, status = await proxy_to_tracking(
        request, f"/stats/email/{email_id}", method="GET", params=dict(request.query_params)
    )
    return JSONResponse(content=data, status_code=status)
...
async def add_suppression(request: Request):
    ...
    data, status = await proxy_to_tracking(
        request, "/tracking/suppress", method="POST", data=await request.json()
    )
    return JSONResponse(content=data, status_code=status)
...
async def remove_suppression(email: str, request: Request):
    ...
    data, status = await proxy_to_tracking(request, f"/tracking/suppress/{email}", method="DELETE")
    return JSONResponse(content=data, status_code=status)
