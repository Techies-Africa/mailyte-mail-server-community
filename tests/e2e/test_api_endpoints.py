...
def get(path, params=None, **kwargs):
    return requests.get(
        f"{API_URL}{path}", headers=api_headers(), params=params, timeout=30, **kwargs
    )
...
def delete(path, data=None, **kwargs):
    return requests.delete(
        f"{API_URL}{path}", headers=api_headers(), json=data, timeout=30, **kwargs
    )
...
class TestOrganizations:
    ...
    def test_update_organization(self, base_org):
        resp = put(
            f"/api/v1/organizations/{base_org['_id']}",
            {
    ...
    def test_update_organization_quotas(self, base_org):
        resp = put(
            f"/api/v1/organizations/{base_org['_id']}/quotas",
            {
...
class TestDomains:
    ...
    def test_update_domain(self, base_domain):
        resp = put(
            f"/api/v1/domains/{base_domain['id']}",
            {
                "description": f"Updated at {datetime.utcnow().isoformat()}",
                "max_users": 75,
            },
    ...
    def test_update_domain_quotas(self, base_domain):
        resp = put(
            f"/api/v1/domains/{base_domain['id']}/quotas",
            {
...
class TestMailboxes:
    ...
    def test_update_email_account(self, base_mailbox):
        resp = put(
            f"/api/v1/email-accounts/{base_mailbox['id']}",
            {
                "name": "Updated Name",
    ...
    def test_update_email_account_quotas(self, base_mailbox):
        resp = put(
            f"/api/v1/email-accounts/{base_mailbox['id']}/quotas",
            {
...
class TestAnalytics:
    ...
    def test_email_volume(self, base_domain):
        resp = get(
            f"/api/v1/analytics/email-volume/{base_domain['_name']}", params={"period": "7d"}
        )
        assert resp.status_code in (200, 503)
...
class TestRateLimiter:
    ...
    def test_set_domain_limits(self, base_domain):
        resp = post(
            f"/api/v1/rate-limiter/rate-limits/domain/{base_domain['_name']}",
            {
                "per_minute": 50,
                "per_hour": 500,
                "per_day": 5000,
    ...
    def test_set_mailbox_limits(self, base_mailbox):
        resp = post(
            f"/api/v1/rate-limiter/rate-limits/mailbox/{base_mailbox['_email']}",
            {
                "per_minute": 10,
                "per_hour": 100,
            },
    ...
    def test_reset_limits(self):
        resp = post(
            "/api/v1/rate-limiter/rate-limits/reset",
            {
                "domain": TEST_DOMAIN,
            },
        )
    ...
    def test_set_domain_quotas(self, base_domain):
        resp = post(
            f"/api/v1/rate-limiter/quotas/domain/{base_domain['_name']}",
            {
                "daily_limit": 10000,
...
class TestStorage:
    ...
    def test_domain_storage_quotas_set(self, base_domain):
        resp = post(
            f"/api/v1/storage/quotas/domain/{base_domain['_name']}",
            {
    ...
    def test_mailbox_storage_quotas_set(self, base_mailbox):
        resp = post(
            f"/api/v1/storage/quotas/mailbox/{base_mailbox['_email']}",
            {
...
class TestTracking:
    ...
    def test_unsubscribe_post(self):
        resp = post(
            f"/api/v1/tracking/unsubscribe/{uid()}",
            {
...
class TestRAG:
    ...
    def test_create_collection(self, base_domain):
        resp = post(
            f"/api/v1/rag/collections/{base_domain['_name']}",
            {
    ...
    def test_organization_rag_config_put(self, base_org):
        resp = put(
            f"/api/v1/rag/organizations/{base_org['_id']}/rag/config",
            {
                "enabled": True,
...
class TestFilters:
    ...
    def test_create_filter(self, base_mailbox):
        resp = post(
            "/api/v1/filters/",
            params={"email": base_mailbox["_email"]},
            data={
...
class TestSharedMailboxes:
    ...
    def test_shared_mailbox_members(self, base_domain, base_mailbox):
        ...
        # Add member
        resp = post(
            f"/api/v1/shared-mailboxes/{mailbox_id}/members",
            data={
        ...
        resp = put(
            f"/api/v1/shared-mailboxes/{mailbox_id}/members/{member_account_id}",
            data={
                "email_account_id": member_account_id,
...
class TestMessageTrace:
    ...
    def test_list_quarantine(self, base_org):
        resp = get(
            "/api/v1/message-trace/quarantine",
            params={
                "organization_id": base_org["_id"],
                "limit": 10,
            },
    ...
    def test_create_transport_rule(self, base_org):
        ...
        if resp.status_code in (200, 201):
            ...
            if rule_id:
                ...
                # Update rule
                resp = put(
                    f"/api/v1/transport-rules/{rule_id}",
                    data={
        ...
        for i in range(2):
            resp = post(
                ...
                data={
                    ...
                    "direction": "both",
                    "conditions": [
                        {"field": "sender", "operator": "equals", "value": f"test{i}@example.com"}
                    ],
                    "condition_logic": "all",
                    "actions": [
                        {"type": "add_header", "params": {"name": "X-Test", "value": str(i)}}
                    ],
                    "priority": (i + 1) * 10,
                    "enabled": True,
                },
...
class TestWhitelabel:
    ...
    def test_update_whitelabel_config(self, base_org):
        resp = put(
            f"/api/v1/whitelabel/config/{base_org['_id']}",
            data={
...
class TestReseller:
    ...
    def test_create_sub_organization(self):
        resp = post(
            "/api/v1/reseller/sub-organizations",
            data={
    ...
    def test_update_sub_organization_plan(self):
        ...
        resp = put(
            f"/api/v1/reseller/sub-organizations/{sub_id}/plan",
            data={
                "max_users": 50,
                "plan_name": "business",
    ...
    def test_billing_summary(self):
        resp = get(
            "/api/v1/reseller/billing/summary",
            params={
                "parent_org_id": self.parent_org_id,
            },
        )
