...
def test_domain(test_org, unique_id):
    ...
    assert resp.status_code in (200, 201), f'Failed to create domain: {resp.status_code} {resp.text}'
...
def test_mailbox(test_domain, unique_id):
    ...
    assert resp.status_code in (200, 201), f'Failed to create mailbox: {resp.status_code} {resp.text}'
...
class TestEmailSending:
    ...
    def test_send_html_email(self, test_mailbox):
        ...
        html_part = MIMEText(
            '<html><body><h1>E2E Test</h1><p>HTML email body.</p></body></html>',
            'html'
        )
        msg.attach(text_part)
    ...
    def test_auth_results_header(self, test_mailbox, sent_email_id):
        ...
        try:
            ...
            if auth_results:
                ...
                has_auth = any(
                    kw in auth_results.lower()
                    for kw in ['spf=', 'dkim=', 'dmarc=']
                )
...
class TestAPIOperations:
    ...
    def test_message_trace(self, test_mailbox):
        ...
        resp = api_get(
            ...
            params={'sender': test_mailbox['email'], 'limit': 10}
        )
    ...
    def test_update_organization(self, test_org):
        ...
        org_id = test_org.get('_org_id') or test_org.get('id')
        resp = api_put(f'/api/v1/organizations/{org_id}', {
    ...
    def test_update_organization_quotas(self, test_org):
        ...
        org_id = test_org.get('_org_id') or test_org.get('id')
        resp = api_put(f'/api/v1/organizations/{org_id}/quotas', {
    ...
    def test_update_mailbox(self, test_mailbox):
        ...
        account_id = test_mailbox.get('id')
        resp = api_put(f'/api/v1/email-accounts/{account_id}', {
...
class TestTracking:
    ...
    def test_suppression_add_and_remove(self, test_mailbox):
        ...
        # Add to suppression
        resp = api_post('/api/v1/tracking/suppress', {
...
class TestWebhooks:
    ...
    def test_webhook_subscription_crud(self, webhook_server):
        ...
        # Create subscription
        resp = api_post('/api/v1/webhooks/subscriptions', {
            'url': webhook_url,
    ...
    def test_webhook_test_endpoint(self, webhook_server):
        ...
        resp = api_post('/api/v1/webhooks/test', {
            'url': webhook_url,
    ...
    def test_webhook_fires_on_send(self, webhook_server, test_mailbox):
        ...
        resp = api_post('/api/v1/queue/mail-queue/flush', {
            'domain': test_mailbox['domain'],
        })
