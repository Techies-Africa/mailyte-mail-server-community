...
class ContainerHealthMonitor:
    ...
    def check_container_status(self, container: Dict) -> Dict:
        ...
        if stdout:
            ...
            # Port binding issues
            if 'address already in use' in logs_lower or 'bind: address already in use' in logs_lower:
    ...
    def fix_permission_denied(self, container_name: str) -> bool:
        ...
        dirs_to_fix = [
            'storage', 'logs', 'storage/mail_data', 
            'storage/ssl_certs', 'storage/attachments'
        ]
    ...
    def fix_file_not_found(self, container_name: str) -> bool:
        ...
        dirs_to_create = [
            'storage', 'logs', 'config',
            'storage/mail_data', 'storage/ssl_certs', 
            'storage/attachments', 'storage/qdrant_data'
        ]
