...
class Organization(Base):
    ...
    external_id = Column(String(255), nullable=True, unique=True, index=True)  # External system identifier
...
class Domain(Base):
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            'last_storage_calculation': self.last_storage_calculation.isoformat() if self.last_storage_calculation else None,
